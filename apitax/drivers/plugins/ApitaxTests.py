...
class ApitaxTestsDriver(Driver):
    ...
    def getCatalog(self, auth):
        ...
        catalog['endpoints'].update({"tests": {"label": "(Test) JSONPlaceHolder - https://jsonplaceholder.typicode.com",
                                               "value": "https://jsonplaceholder.typicode.com"}})
        catalog['endpoints'].update(
            {"reqres": {"label": "(Test) Requests - https://reqres.in/", "value": "https://reqres.in/"}})
